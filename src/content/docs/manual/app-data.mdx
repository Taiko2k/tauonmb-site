...
> **Tip**: If you're moving installation and jsut want to keep playtimes, just make sure to copy the `star.p` file from the old program data folder to the new one.
